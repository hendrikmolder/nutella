...
pegasus-kickstart -n findrange -N ID0000002 -R condorpool  -L diamond -T 2018-06-14T17:44:54+01:00 /usr/bin/curl  http://localhost/ocpu/library/teste/R/hello -d "x='f.b1'&y='/tmp/qh/pegasus/diamond/run0014/f.c1'"
job_ec=$?
