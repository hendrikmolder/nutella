...
pegasus-kickstart -n svn0 -N ID0000000 -R condorpool  -s a.csv=a.csv -s a2.csv=a2.csv -L wrangling -T 2018-07-02T20:00:17+01:00 /home/qh/wranglingWF/bin/svn0.sh  a.csv a2.csv 
job_ec=$?
