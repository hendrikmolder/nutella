...
# execute the command
/usr/bin/curl http://192.168.42.114/ocpu/library/wranglingB/R/mutate_one -d "input='/home/qh/opencputmp/$input1'&output='/home/qh/opencputmp/$output1'&colna='JC'&expre='AvgSpeed/3.01'"
