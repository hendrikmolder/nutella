...
# execute the command
/usr/bin/curl http://192.168.42.114/ocpu/library/wranglingA/R/separate_two -d "input='/home/qh/opencputmp/$input1'&output='/home/qh/opencputmp/$output1'&oldcol='Sdate'&newcol1='date'&newcol2='time'&symb=' '"
