...
# execute the command
/usr/bin/curl http://192.168.42.114/ocpu/library/wranglingA/R/filter_include -d "input='/home/qh/opencputmp/$input1'&output='/home/qh/opencputmp/$output1'&colname='day'&target='7,14,21,28'"
