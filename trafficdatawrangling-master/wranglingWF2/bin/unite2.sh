...
# execute the command
/usr/bin/curl http://192.168.42.114/ocpu/library/wranglingB/R/unite_col -d "input='/home/qh/opencputmp/$input1'&output='/home/qh/opencputmp/$output1'&colname='date'&target='year,month,day'&sepsign='/'"
