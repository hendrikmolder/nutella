...
# execute the command
/usr/bin/curl http://192.168.42.114/ocpu/library/wranglingA/R/separate_three -d "input='/home/qh/opencputmp/$input1'&output='/home/qh/opencputmp/$output1'&oldcol='date'&newcol1='day'&newcol2='month'&newcol3='year'&symb='/'"
