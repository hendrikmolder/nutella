...
# execute the command
/usr/bin/curl http://192.168.42.114/ocpu/library/wranglingB/R/barchart -d "input='/home/qh/opencputmp/$input1'&output='/home/qh/opencputmp/$output1'&col1='date'&col2='sum'&wid=30&hei=5&wid2=0.5"
