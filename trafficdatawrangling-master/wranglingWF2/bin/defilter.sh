...
# execute the command
/usr/bin/curl http://192.168.42.114/ocpu/library/wranglingA/R/filter_include -d "input='/home/qh/opencputmp/$input1'&output='/home/qh/opencputmp/$output1'&colname='day'&target='1,2,5,6,7,8,9,12,13,14,15,16,19,20,21,22,23,26,27,28'"
